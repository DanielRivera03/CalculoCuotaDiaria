...
?>
        ...
        <head>
            ...
            <title>CashMan H.A. | Gestor Cuotas Diarias</title>
            <!-- Favicon icon -->
        ...
        <body class="h-100">
            <div class="progress ">
                <div class="progress-bar bg-warning progress-animated" style="width: 50%; height:15px;" role="progressbar"></div>
            </div>
                                ...
                                <div class="row no-gutters">
                                    <div class="col-xl-12">
                                        <div class="auth-form">
                                            ...
                                            <h3 class="text-center mb-4">Generador Cuotas Diarias</h3>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="profile-photo">
                                                        ...
                                                        <div class="alert alert-light alert-dismissible alert-alt solid fade show">
															...
															<strong>Tomar Nota: </strong> Este es un generador simple de cuotas diarias seg&uacute;n el tiempo estipulado. Solamente se realiza el c&aacute;lculo simple de una posible cuota diarias con sus tasas de inter&eacute;s diaria, no se incluyen otros agregados que las instituciones financieras establecen.
														</div>
                                                            <div class="col-xl-12">
                                                                <form id="ingreso-datos-credito-clientes" action="mostrarestadocuenta.php" class="form-valide" name="formulariocreditosclienteshipotecas" method="post" autocomplete="off">
                                                                    <div class="row form-validation">
                                                                        ...
                                                                        <div class="col-lg-6 mb-2">
                                                                            <div class="form-group">
                                                                                <label class="text-label">Fecha Inicial Pr&eacute;stamo <span class="text-danger">*</span></label>
                                                                                <div class="col-lg-12">
                                                                                    <div class="input-group mb-3  input-primary">
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text"><i class="ti ti-shopping-cart-full"></i></span>
                                                                                        </div>
                                                                                        <input type="text" class=" form-control" id="val-fechacreditos" name="val-fechainiciocreditos" placeholder="Ingrese fecha de inicio de cr&eacute;dito" readonly value="<?php echo date("Y-m-d"); ?>">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-6 mb-2">
                                                                            <div class="form-group">
                                                                                <label class="text-label">Fecha Finalizaci&oacute;n Pr&eacute;stamo <span class="text-danger">*</span></label>
                                                                                <div class="col-lg-12">
                                                                                    <div class="input-group mb-3  input-primary">
                                                                                        <div class="input-group-prepend">
                                                                                            <span class="input-group-text"><i class="ti ti-calendar"></i></span>
                                                                                        </div>
                                                                                        <input type="text" class=" form-control" id="val-fechacreditosfinal" name="val-fechacreditos" placeholder="Ingrese fecha de inicio de cr&eacute;dito" readonly value="<?php echo date("Y-m-d"); ?>">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-lg-12 mb-2">
                                                                            <!-- ENVIO DATOS -->
                                                                            <button type="submit" id="enviar-datos-creditos" class="btn light btn-success"><i class="ti-hand-point-right"></i> Procesar Informaci&oacute;n y Generar Cuotas Diaras</button>
                                                                        </div>
                                                                </form>  
                                                    </div>
                                                </div>
